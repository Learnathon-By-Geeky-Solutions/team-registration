...
export function TeamDetails({ team, onTeamUpdated, onTeamDeleted }: TeamDetailsProps) {
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              <h3 className="text-sm font-medium text-gray-500">Team Member 1</h3>
            ...
            <div>
              <h3 className="text-sm font-medium text-gray-500">Team Member 2</h3>
